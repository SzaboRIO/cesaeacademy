...
<div class="barra-roxa">
    ...
    <p>Aqui pode alterar toda a informação de um utilizador, inclusive editar o role para formador.</p>
</div>
                        ...
                        <form action="{{ route('admin.update_user', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select form-select-purple" id="role" name="role">
                                    ...
                                    <option value="formador" {{ $user->role == 'formador' ? 'selected' : '' }}>Formador</option>
